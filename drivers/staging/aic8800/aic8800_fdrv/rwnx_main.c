...
#define RW_DRV_DESCRIPTION  "AICSemi AIC8800D80 USB Wi-Fi driver"
...
static void __maybe_unused system_config_8800(struct rwnx_hw *rwnx_hw)
{
    int syscfg_num;
    int ret, cnt;
...
static int __maybe_unused wdt_config(struct rwnx_hw *rwnx_hw)
{
    int ret = 0;
    ret = rwnx_send_dbg_mem_mask_write_req(rwnx_hw,
...
static void __maybe_unused aicwf_usb_config(struct rwnx_hw *rwnx_hw)
{
    int usbcfg_num = 0;
    int ret = 0, cnt = 0;
    struct dbg_mem_read_cfm rd_mem_addr_cfm;
...
static int __maybe_unused start_from_bootrom(struct rwnx_hw *rwnx_hw)
{
    int ret = 0;
...
static void rwnx_task(unsigned long data)
{
